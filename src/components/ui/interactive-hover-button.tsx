...
>(({ className, ...props }, ref) => {
  return (
    ...
    >
      ...
      {/* Magical Blob */}
      <div className="absolute left-[25%] top-[45%] h-2 w-2 scale-100 rounded-xl bg-medhive-500 opacity-10 blur-md transition-all duration-500 ease-out group-hover:left-0 group-hover:top-0 group-hover:h-full group-hover:w-full group-hover:scale-[2] group-hover:opacity-20" />
    </button>
  );
});
