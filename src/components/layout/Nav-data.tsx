//src/components/layout/Nav-data.tsx
...
export function Navbar() {
  ...
  const navLinks = [
    ...
    {
      name: "DATA UPLOAD",
      path: "/data-upload#data-upload-section",
      scroll: false,
    },
    { name: "API KEYS", path: "/data-upload/api-keys", newTab: true },
    { name: "API DOCS", path: "/data-upload/api-docs", newTab: true },
  ];
