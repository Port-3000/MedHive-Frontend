...
export default function DataUploadPage() {
  const [context, setContext] = useState<string>("None");
      ...
      >
        ...
        >
          ...
          <div
            ...
            className={`w-full h-64 flex flex-col justify-center items-center border-2 border-dashed rounded-xl p-4 text-white transition-colors ${dropActive
      ...
      "
        >
          <CopilotChat
            ...
            instructions={`You are assisting the user as best as you can. Answer in the best way possible given the data you have. ${context
