        ...
        <section className="relative z-10 pt-16 pb-20">
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <h1 className="font-['Kagitingan'] text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight mb-4 bg-gradient-to-r from-medhive-200 to-medhive-500 text-transparent bg-clip-text leading-tight">
                ...
                <div className="bg-gradient-to-br from-purple-900/20 via-black/80 to-indigo-900/20 p-8 rounded-2xl border border-purple-500/20 backdrop-blur-sm shadow-[0_0_30px_rgba(168,85,247,0.15)]">
                  ...
                  <ul className="space-y-4">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <p className="text-gray-300">
                        Access all MedHive models trained on diverse global
                        datasets
                      </p>
                    </li>
                    <li className="flex items-start gap-3">
        ...
        <section className="relative z-10 py-10">
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <h2 className="text-5xl md:text-5xl font-['Kagitingan'] mb-4 bg-gradient-to-r from-medhive-200 to-medhive-400 bg-clip-text text-transparent">
                Why Hospitals Choose MedHive
              </h2>
